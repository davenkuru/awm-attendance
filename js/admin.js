...
function setMemberView(view) {
  ...
  const gradDateFilters = document.getElementById('grad-date-filters');
  const gradExportBtn  = document.getElementById('grad-export-btn');
  ...
  if (view === 'graduated') {
    ...
    if (gradDateFilters)  gradDateFilters.style.display = 'flex';
    if (gradExportBtn)    gradExportBtn.style.display = 'flex';
    ...
    if (gradDateFilters)  gradDateFilters.style.display = 'none';
    if (gradExportBtn)    gradExportBtn.style.display = 'none';
    if (bulkBar)          bulkBar.style.display = 'none';
    if (levelTabs)        levelTabs.style.display = 'none';
